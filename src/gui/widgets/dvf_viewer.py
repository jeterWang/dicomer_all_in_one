...
class DVFViewer(QWidget):
    ...
    def init_ui(self):
        ...
        left_layout.setContentsMargins(5, 5, 5, 5)  # 较小的边距
        ...
        # 设置左侧面板的固定宽度
        left_panel.setFixedWidth(300)  # 增加宽度，适应控制元素
