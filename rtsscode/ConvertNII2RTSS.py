...
if __name__ == "__main__":
    ...
    input_nifti = r"C:\Users\elekta\Desktop\jiteng\code\dicomer_all_in_one\output\rtsstest\DRM_mask.nii.gz"
    input_dicom = r"C:\Users\elekta\Desktop\jiteng\code\dicomer_all_in_one\output\rtsstest\img"
    output_dicom = r"C:\Users\elekta\Desktop\jiteng\code\dicomer_all_in_one\output\rtsstest"


    # 将斜杠替换为反斜杠
    input_nifti = input_nifti.replace("/", "\\")
    input_dicom = input_dicom.replace("/", "\\")
    output_dicom = output_dicom.replace("/", "\\")

    convert(input_nifti, input_dicom, output_dicom)
